...
<body>
	<div style="width: 100%; padding: 20px">
		<img loading="lazy" src="{{env('APP_URL')}}/{{$artpiece->image}}" width="200px">
		<br>
		Hi,
		<br><br>
		{{$name}} sent an inquiry.
		<br><br>
		Click this <a href="{{env('APP_URL')}}/the-gallery?id={{$artpiece->id}}" class="text-red">link</a> to view the artpiece inquired.
		<br><br>
		<b>Message content:</b>
		<br><br>
		...
		<b>Viewing date & time:</b> {{date('M d, Y', strtotime($date))}} {{date('h:i A', strtotime($time))}}
		<br><br>
