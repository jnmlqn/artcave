...
<body>
	<div style="width: 100%; padding: 20px">
		<center><img loading="lazy" src="{{env('APP_URL')}}/{{$image}}" width="80%"></center>
		<br>
		Hi {{$first_name}} {{$last_name}},
		<br><br>
		Please check our new promo here at ArtCave Gallery and Cafe.
		<br><br>
		Click this <a href="{{env('APP_URL')}}/promos-and-events?id={{$id}}" class="text-red">link</a> to learn more.
		<br><br>
		Thank you!
		<br><br>
		This is an automatically generated email from our subscription list. Please do not reply to this email.
	</div>
